...
struct ConfigDef MuttVars[] = {
  ...
  ** unread messages.
  */
  { "compose_format",   DT_STRING|DT_NOT_EMPTY|DT_NOT_EMPTY,  R_MENU, &ComposeFormat, IP "-- NeoMutt: Compose  [Approx. msg size: %l   Atts: %a]%>-" },
  /*
  ** .pp
  ...
  ** (PGP only)
  */
  { "pgp_timeout",      DT_NUMBER|DT_NOT_NEGATIVE,  R_NONE, &PgpTimeout, 300 },
  /*
  ** .pp
